...
namespace DotNetProject.Migrations
{
    ...
    [Migration("20260103083810_SwapMediaUrlsReliable")]
    partial class SwapMediaUrlsReliable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DotNetProject.Models.Character", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ImageUrl = "https://upload.wikimedia.org/wikipedia/en/4/4a/Rachel_Green_Friends.jpg",
                            Name = "Rachel Green",
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://upload.wikimedia.org/wikipedia/en/e/e2/Monica_Geller_Courteney_Cox.jpg",
                            Name = "Monica Geller",
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://upload.wikimedia.org/wikipedia/en/f/f0/Joey_Tribbiani.jpg",
                            Name = "Joey Tribbiani",
                            Occupation = "Actor",
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://upload.wikimedia.org/wikipedia/en/6/6c/Chandler_Bing_Matthew_Perry.jpg",
                            Name = "Chandler Bing",
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://upload.wikimedia.org/wikipedia/en/6/6f/Ross_Geller.jpg",
                            Name = "Ross Geller",
            ...
            modelBuilder.Entity("DotNetProject.Models.Episode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EpisodeNumber = 1,
                            ImageUrl = "https://upload.wikimedia.org/wikipedia/en/d/d6/Friends_Season_1_DVD.jpg",
                            Season = 1,
                        ...
                        new
                        {
                            ...
                            EpisodeNumber = 7,
                            ImageUrl = "https://upload.wikimedia.org/wikipedia/en/f/f6/Friends_Season_2_DVD.jpg",
                            Season = 2,
                        ...
                        new
                        {
                            ...
                            EpisodeNumber = 2,
                            ImageUrl = "https://upload.wikimedia.org/wikipedia/en/1/16/Friends_Season_3_DVD.jpg",
                            Season = 3,
            ...
            modelBuilder.Entity("DotNetProject.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/7/7e/Central_Perk_at_Warner_Bros_Studio_Tour_Hollywood.jpg",
                            Name = "Central Perk",
                            Type = "Coffee Shop",
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/4/48/90_Bedford_Street%2C_New_York_City.jpg",
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/3/3d/AMNH_entrance.jpg",
